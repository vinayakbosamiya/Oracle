...
-- SELECT * FROM USER WHERE GENDER IN ('MALE');
-- SELECT * FROM USER WHERE GENDER = 'FEMALE' AND SALARY > 50000;
-- SELECT * FROM USER WHERE GENDER = 'MALE' OR SALARY >40000 ORDER BY SALARY ASC LIMIT 6;

-- QUICK QUIZ
-- SELECT * FROM USER WHERE SALARY > 60000 ORDER BY CREATE_AT DESC LIMIT 5;
